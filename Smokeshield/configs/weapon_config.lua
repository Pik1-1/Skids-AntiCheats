EASYACW = {} -- DON'T CHANGE


---# Anti Weapon #---
EASYACW.AntiBlackListWeapon  = true
EASYACW.AntiAddWeapon        = true
EASYACW.AntiRemoveWeapon     = true
EASYACW.AntiWeaponsExplosive = true
EASYACW.WeaponPunishment     = "BAN" -- BAN/KICK/WARN

---# Anti Weapon Damage Changer #---
EASYACW.AntiWeaponDamageChanger   = true
EASYACW.AntiVehicleDamageChanger  = true
EASYACW.DamagePunishment          = "BAN" -- BAN/KICK/WARN
